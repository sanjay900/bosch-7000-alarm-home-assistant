...
from bosch_alarm_map.panel import Panel, ArmCommand, ExitDelay
...
class AreaAlarmControlPanel(BoschAlarmAreaEntity, AlarmControlPanelEntity):
    ...
    async def async_alarm_disarm(self, code: str | None = None) -> None:
        """Disarm this panel."""
        await self.panel.arm(ArmCommand.DISARM, False, ExitDelay.ZERO)
    ...
    async def async_alarm_arm_away(self, code: str | None = None) -> None:
        ...
        await self.panel.arm(ArmCommand.ARM, False, ExitDelay.EXTENDED)
